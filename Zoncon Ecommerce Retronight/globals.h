...
static NSString *DB_FILENAME = @"zoncon_ecommerce_retronight.db";
static NSString *SHARE_MSG = @"ZonCon ECommerce Retronight App";
static NSString *SHARE_SUBJECT = @"ZonCon E-Commerce Retronight App";
static NSString *SHARE_CONTENT = @"Thank you for downoading the ZonCon E-Commerce App!";
static NSString *FEEDBACK_EMAIL_SUBJECT = @"ZonCon E-Commerce Retronight App Feedback";
