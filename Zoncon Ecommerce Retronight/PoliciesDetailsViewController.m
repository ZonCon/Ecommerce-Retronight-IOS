//
//  PoliciesDetailsViewController.m
//  PNG Diamonds
//
...
@interface PoliciesDetailsViewController ()

@end

@implementation PoliciesDetailsViewController
...
- (void)viewDidLoad {
    ...
    for(int i = 0; i < arr.count; i++) {
        ...
        for(int j = 0; j < arrItems.count; j++) {
            ...
            //NSLog(@"Attachments = %d", arrAttachments_1.count);
            for(int k = 0; k < arrAttachments_1.count; k++) {
                ...
                labelAttachment.textAlignment = NSTextAlignmentLeft; // UITextAlignmentCenter, UITextAlignmentLeft
